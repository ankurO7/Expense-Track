...
- **Log Daily Expenses:** Add expense details such as amount, category, and description.
- **Interactive Charts:** Visualize spending patterns in real time using Chart.js.
- **Dynamic Categories:** Organize expenses by category for better insight.
- **Clean User Interface:** Simple and user-friendly design.
- **Client-Side Application:** No backend required; runs directly in your browser.
- **Local Storage Support:** (If implemented) Saves expense data between sessions.
